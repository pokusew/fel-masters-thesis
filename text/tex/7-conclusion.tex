...
To support adoption of our implementation by people from all over the world, we gave our implementation a~name – LionKey – and we designed a~logo. We also purchased the domain \ulink[https://lionkey.dev/]{{\tt lionkey.dev}} and launched a~website with information about the project and with documentation. We plan to gradually add more detailed documentation.
