...
\_def\ctustyleversion{Jul.2023 beta(v)}
...
\.mtdef {specifi}      {Assignment}        {Zadání}         {Zadanie}
...
\_def\.specifipage{\_if&\_the\specification&\_else
   ...
   \_the\_ea\specification\_space \_vfil\_break \_fi}
...
\_def\.abstractpage{
   ...
   \_setbox\.leftbox=\_vbox{\.sethsizefront
         ...
         \_if&\_the\keywordsEN&\_else\_vskip3mm{\.bf\_mtext{keywords}:} \_the\keywordsEN\_par\_fi
         \_ifnum\.orilang=\_language \_else
            \_if&\_the\titleEN&\_else\_vskip3mm{\.bf\_mtext{trans}:} \_the\titleEN
   ...
   \_setbox\.rightbox=\_vbox{\.sethsizefront
         ...
         \_fi
         \_if&\_the\.keywords&\_else\_vskip3mm{\.bf\_mtext{keywords}:} \_the\.keywords\_par\_fi
         \_ifnum\.orilang=\_language \_else
            \_if&\_the\.titleL&\_else\_vskip3mm{\.bf\_mtext{trans}:} \_the\.titleL
   ...
   \_ifx\.abstractpage\_relax \_else
      ...
      \_ifvoid\.leftbox
         ...
         \_insertoutline{Abstract/Abstrakt}
         \.frontpage[Abstract/Abstrakt]
      \_else
